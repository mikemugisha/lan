% runCompoundNetworkSim.m

function result = runCompoundNetworkSim(K, p, N)
    % Function to simulate a compound network
    ...
    for i = 1:N
        ...
        while pktSuccessCount < K
            ...
            r3 = rand; % gen random num to determine if packet is successful (r3 > p)
            txAttemptCount = txAttemptCount + 1; % count 1st attempt on the series link

            % while packet transmissions on the series link are not successful (r3 < p)
            while r3 < p
